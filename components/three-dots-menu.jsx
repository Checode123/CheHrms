            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-2">
                  ...
                  <h3 className="text-sm font-semibold text-gray-700">Hostel Services</h3>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {hostelServices.map((service) => (
                    <div
                      key={service.title}
                      className={cn(
                        "flex items-center space-x-3 p-3 rounded-lg transition-all duration-300 hover:scale-105 cursor-pointer",
                        service.bgColor,
                      )}
                    >
